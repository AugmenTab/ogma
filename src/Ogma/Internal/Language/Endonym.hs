...
--
module Ogma.Internal.Language.Endonym
  ( languageEndonymToBytes
  , languageEndonymToText
  ) where
...
languageEndonymToBytes :: Language -> Maybe LBS.ByteString
languageEndonymToBytes endonym =
  case endonym of
    APucikwar -> Nothing
    Aari -> Nothing
    Aariya -> Nothing
    ...
    Acheron -> Nothing
    Achinese -> Just "Aceh"
    Achterhooks -> Just "Achterhooks"
    AchuarShiwiar -> Nothing
    Achumawi -> Just "Ajúmmááwí"
    ...
    Adioukrou -> Just "mɔjukru"
    Adithinngithigh -> Nothing
    AdivasiOriya -> Nothing
    AdiwasiGarasia -> Nothing
    Adonara -> Nothing
    Aduge -> Nothing
    Adyghe -> Just "адыгэбзэ"
    Adynyamathanha -> Just "Yura Ngawarla"
    Adzera -> Nothing
    Aeka -> Nothing
    Aekyom -> Nothing
    Aequian -> Nothing
    ...
    Aguacateco -> Just "awakateko"
    Aguano -> Nothing
    Aguaruna -> Just "awajun"
    Aguna -> Nothing
    ...
    Akha -> Nothing
    Akhvakh -> Nothing
    Akkadian -> Just "akkadû"
    AkkalaSami -> Nothing
    Aklanon -> Just "Inakeanon"
    Akolet -> Nothing
    Akoose -> Nothing
    Akoye -> Nothing
    Akpa -> Nothing
    ...
    Alaba -> Nothing
    Alabama -> Just "Albaamo innaaɬiilka"
    ...
    Albanian_Gheg -> Just "gegnisht"
    Albanian_Tosk -> Just "toskërishte"
    ...
    Alekano -> Nothing
    Alemannic -> Nothing
    Aleut -> Just "Unangax tunuu"
    AlgerianJewishSignLanguage -> Nothing
    AlgerianSignLanguage -> Nothing
    Algonquin -> Just "Anishnaabemowin (Omaamiwininimowin)"
    Ali -> Nothing
    Alladian -> Nothing
    Allar -> Nothing
    Alngith -> Nothing
    ...
    Altai_Southern -> Just "Алтай тили"
    AluKurumba -> Nothing
    Alugu -> Nothing
    AlumuTesu -> Nothing
    Alune -> Nothing
    ...
    Angkamuthi -> Nothing
    AngloNorman -> Nothing
    AngloSaxon -> Just "Englisc"
    Angloromani -> Just "Romanichal"
    Angolar -> Nothing
    Angor -> Nothing
    Angoram -> Nothing
    ...
    Arandai -> Nothing
    Araona -> Nothing
    Arapaho -> Just "Hinono'eitiit"
    Arapaso -> Nothing
    Arara_MatoGrosso -> Nothing
    Ararandewara -> Nothing
    Araucanian -> Just "Mapudungun"
    Arawak -> Nothing
    Arawete -> Nothing
    Arawum -> Nothing
    Arbore -> Nothing
    ...
    Arma -> Nothing
    Armazic -> Nothing
    Armenian -> Just "Հայերեն"
    ArmenianSignLanguage -> Nothing
    Aromanian -> Just "Armăneashce"
    AropLukep -> Nothing
    AropSissano -> Nothing
    Arosi -> Nothing
    ...
    Asoa -> Nothing
    Assamese -> Just "অসমীয়া"
    Assan -> Nothing
    Assangori -> Nothing
    Assiniboine -> Just "Nakʰóda"
    AssyrianNeoAramaic -> Just "ܣܘܪܝܝܐ  ܣܘܪܝܬ,ܐܬܘܪܝܐ ܣܘܪܝܝܐ"
    Asturian -> Just "asturianu"
    Asu_Nigeria -> Nothing
    ...
    BasaGumna -> Nothing
    BasaGurmana -> Nothing
    Basa_Cameroon -> Just "ɓasaá"
    Basa_Nigeria -> Nothing
    Basap -> Nothing
    Basay -> Nothing
    Bashkardi -> Nothing
    Bashkir -> Just "башҡорт"
    Basketo -> Nothing
    Basque -> Just "euskara"
    Bassa -> Nothing
    ...
    Birwa -> Nothing
    Biseni -> Nothing
    BishnupriyaManipuri -> Just "বিষ্ণুপ্রিয়া মণিপুরী"
    Bishuo -> Nothing
    Bisis -> Nothing
    Bislama -> Just "Bislama"
    Bisorio -> Nothing
    Bissa -> Nothing
    Bisu -> Nothing
    Bit -> Nothing
    ...
    Cavinena -> Nothing
    Cayubaba -> Nothing
    Cayuga -> Just "Goyogo̱hó:nǫ’"
    Cayuse -> Nothing
    CebaaraSenoufo -> Nothing
    Cebuano -> Just "S(in)ugboanon"
    Celtiberian -> Nothing
    Cemuhi -> Nothing
    Cen -> Nothing
    CentralAsmat -> Nothing
    CentralAtlasTamazight -> Just "ⵜⵎⴰⵣⵉⵖⵜ"
    CentralBai -> Nothing
    ...
    CentralOjibwa -> Just "Anishinaabemowin (Ojibwemowin)"
    CentralOkinawan -> Just "うちなーぐち"
    ...
    CentralTarahumara -> Just "Ralámuli"
    ...
    Chinese -> Just "中文; 汉语; 华语"
    ChinesePidginEnglish -> Nothing
    ChineseSignLanguage -> Nothing
    Chinook -> Nothing
    ChinookJargon -> Just "chinuk wawa"
    Chipaya -> Nothing
    Chipewyan -> Just "ᑌᓀᓲᒢᕄᓀ(Dëne Sųłiné)"
    Chipiajes -> Nothing
    Chippewa -> Just "ᐊᓂᐦᔑᓈᐯᒧᐧᐃᓐ / ᐅᒋᐧᐯᒧᐧᐃᓐ(Anishinaabemowin / Ojibwemowin)"
    ...
    Coptic -> Just "ⲙⲉⲧⲛ̀ⲣⲉⲙⲛ̀ⲭⲏⲙⲓ"
    Coquille -> Nothing
    Cori -> Nothing
    Cornish -> Just "Kernewek"
    ...
    Cree -> Just "ᓀᐦᐃᔭᐤ(Nehiyāw)"
    Cree_Moose -> Nothing
    Cree_Plains -> Nothing
    Cree_Swampy -> Nothing
    Cree_Woods -> Nothing
    Creek -> Just "Mvskokē"
    CrimeanTatar -> Just "Къырым Татар"
    ...
    Dumun -> Nothing
    Duna -> Nothing
    Dungan -> Just "Хуэйзў йүян (Huejzw jyian)"
    Dungmali -> Nothing
    DungraBhil -> Nothing
    Dungu -> Nothing
    ...
    EasternOjibwa -> Just "Nishnaabemwin (Jibwemwin)"
    ...
    Embu -> Nothing
    Emerillon -> Nothing
    Emilian -> Just "emigliàṅ"
    EmilianoRomagnolo -> Just "emigliàn e rumagnòl"
    Emok -> Nothing
    Emplawas -> Nothing
    Emumu -> Nothing
    En -> Nothing
    ...
    Fang_EquatorialGuinea -> Just "Fang"
    Fania -> Nothing
    Fanti -> Nothing
    FarWesternMuria -> Nothing
    Farefare -> Nothing
    Faroese -> Just "føroyskt"
    Fas -> Nothing
    Fasu -> Nothing
    Fataleka -> Nothing
    Fataluku -> Nothing
    ...
    Finnish_Tornedalen -> Just "meänkieli"
    Finongan -> Nothing
    Fipa -> Nothing
    Firan -> Nothing
    Fiwaga -> Nothing
    ...
    FrancoProvencal -> Just "francoprovensal"
    Frankish -> Just "Fränkisch"
    French -> Just "français"
    FrenchSignLanguage -> Nothing
    Friulian -> Just "furlan"
    Fulah -> Just "Fulfulde"
    ...
    Gadjerawang -> Nothing
    Gadsup -> Nothing
    Gaelic_Scots -> Just "Gàidhlig"
    Gafat -> Nothing
    Gagadu -> Nothing
    Gagauz -> Just "Gagauz dili"
    GagnoaBete -> Nothing
    Gagu -> Nothing
    Gahri -> Nothing
    Gaikundi -> Nothing
    ...
    Gikyode -> Nothing
    Gilaki -> Nothing
    Gilbertese -> Just "taetae ni Kiribati"
    Gilima -> Nothing
    Gilyak -> Just "нивхгу"
    ...
    Haeke -> Nothing
    Hahon -> Nothing
    Haida -> Just "X̲aat Kíl"
    Haigwai -> Nothing
    HainyaxoBozo -> Nothing
    Haiom -> Nothing
    HaiphongSignLanguage -> Nothing
    Haisla -> Just "X̄a'’islak̓ala"
    Haitian -> Just "kreyòl ayisyen"
    ...
    Halia -> Nothing
    Halkomelem -> Just "Hǝn̓q̓ǝmin̓ǝm̓"
    Hamap -> Nothing
    Hamba -> Nothing
    HamerBanna -> Nothing
    Hamtai -> Nothing
    ...
    Hawaiian -> Just "ʻōlelo Hawaiʻi"
    Haya -> Nothing
    Hazaragi -> Nothing
    Hdi -> Nothing
    Hebrew -> Just "עִבְרִית"
    Hehe -> Nothing
    Heiban -> Nothing
    Heiltsuk -> Just "hailhzaqvla"
    HelambuSherpa -> Nothing
    Helong -> Nothing
    Hema -> Nothing
    Hemba -> Nothing
    Herde -> Nothing
    Herero -> Just "Otjiherero"
    Hermit -> Nothing
    Hernican -> Nothing
    Hertevin -> Nothing
    Hewa -> Nothing
    ...
    Hupla -> Nothing
    Hurrian -> Nothing
    HutteriteGerman -> Just "Hutterisch"
    Hwana -> Nothing
    Hya -> Nothing
    Hyam -> Nothing
    IWak -> Nothing
    ...
    Inapang -> Nothing
    Inapari -> Nothing
    InariSami -> Just "säämi"
    IndianSignLanguage -> Nothing
    IndoPortuguese -> Nothing
    Indonesian -> Just "bahasa Indonesia"
    ...
    Ineseno -> Nothing
    Inga -> Nothing
    Ingrian -> Just "ižoran keeli"
    Ingush -> Just "гӀалгӀай"
    InlaodItneg -> Nothing
    InokeYate -> Nothing
    Inonhan -> Nothing
    Inor -> Nothing
    InpuiNaga -> Nothing
    Interglossa -> Nothing
    Interlingua -> Just "interlingua"
    Interlingue -> Just "Interlingue"
    InternationalSign -> Nothing
    Interslavic -> Just "medžuslovjansky, mеджусловјанскы"
    Intha -> Nothing
    InuitSignLanguage -> Nothing
    Inuktitut -> Just "ᐃᓄᒃᑎᑐᑦ"
    Inuktitut_EasternCanadian -> Nothing
    Inuktitut_WesternCanadian -> Nothing
    Inupiaq -> Just "Iñupiaq"
    IowaOto -> Nothing
    IpekaTapuia -> Nothing
    Ipiko -> Nothing
    Ipili -> Nothing
    ...
    IsthmusZapotec -> Just "Diidxazá'"
    Istriot -> Nothing
    IstroRomanian -> Just "istroromånă"
    Isu_FakoDivision -> Nothing
    Isu_MenchumDivision -> Nothing
    Italian -> Just "italiano"
    ItalianSignLanguage -> Nothing
    Itawit -> Nothing
    Itelmen -> Just "Итэнмэн"
    Itene -> Nothing
    Iteri -> Nothing
    Itik -> Nothing
    Ito -> Nothing
    ...
    JamaicanCreoleEnglish -> Just "Jumiekan Patwa"
    ...
    JudeoArabic -> Nothing
    JudeoBerber -> Nothing
    JudeoCrimeanTatar -> Just "Кърымчах"
    JudeoGeorgian -> Just "קיברולי"
    ...
    Kaburi -> Nothing
    Kabutra -> Nothing
    Kabuverdianu -> Just "kriolu kabuverdianu"
    Kabwa -> Nothing
    Kabwari -> Nothing
    Kabyle -> Just "Taqbaylit"
    ...
    Kaiep -> Nothing
    Kaikadi -> Nothing
    KaikavianLiteraryLanguage_Kajkavian -> Just "Kajkavski"
    Kaike -> Nothing
    Kaiku -> Nothing
    Kaimbe -> Nothing
    Kaimbulawa -> Nothing
    ...
    Kalkutungu -> Nothing
    Kalmyk -> Just "хальмг"
    KaloFinnishRomani -> Just "Romanó Kaló"
    Kalou -> Nothing
    Kaluli -> Nothing
    Kalumpang -> Nothing
    Kam -> Nothing
    ...
    KarachayBalkar -> Just "Къарачай-Малкъар"
    Karadjeri -> Nothing
    ...
    Kasem -> Nothing
    Kashaya -> Nothing
    Kashmiri -> Just "كشميري"
    Kashubian -> Just "kaszëbsczi"
    Kasiguranin -> Nothing
    Kaska -> Just "Dene Dzage"
    Kaskean -> Nothing
    Kasseng -> Nothing
    Kasua -> Nothing
    Kataang -> Nothing
    ...
    Kibiri -> Nothing
    Kiche -> Just "k'iche’"
    Kickapoo -> Just "kikapú"
    Kikai -> Nothing
    Kikuyu -> Just "Gĩkũyũ"
    KildinSami -> Just "самь"
    Kilivila -> Nothing
    Kiliwa -> Nothing
    Kilmeri -> Nothing
    Kim -> Nothing
    ...
    Kintaq -> Nothing
    Kinuku -> Nothing
    Kinyarwanda -> Just "kinyaRwanda"
    Kioko -> Nothing
    Kiong -> Nothing
    Kiorr -> Nothing
    Kiowa -> Just "Cáuijo̱:gà"
    Kipsigis -> Nothing
    Kiput -> Nothing
    KirBalar -> Nothing
    Kire -> Nothing
    ...
    Kizamani -> Nothing
    KlaDan -> Nothing
    KlallamClallam -> Just "nəxʷsƛʼayʼəmʼúcən"
    KlamathModoc -> Nothing
    Klao -> Nothing
    KliasRiverKadazan -> Nothing
    Klingon -> Just "tlhIngan Hol"
    Knaanic -> Nothing
    Ko -> Nothing
    Koalib -> Nothing
    Koasati -> Nothing
    ...
    Kongo -> Just "Kikongo"
    Konjo -> Nothing
    Konkani_Generic -> Just "कॊंकणि"
    Konkani_Specific -> Just "ಕೊಂಕಣಿ"
    Konkomba -> Nothing
    Konni -> Nothing
    Kono_Guinea -> Nothing
    ...
    KorupunSela -> Nothing
    Korwa -> Nothing
    Koryak -> Just "нымылг'эн йилыйыл, чав'чывэн йилыйил"
    Kosadle -> Nothing
    KosarekYale -> Nothing
    Kosena -> Nothing
    Koshin -> Nothing
    Kosraean -> Just "Kosrae"
    ...
    Ladakhi -> Nothing
    Ladin -> Just "ladin"
    Ladino -> Just "ג'ודיאו–איספאנייול"
    LadjiLadji -> Nothing
    LaekoLibuat -> Nothing
    Lafofa -> Nothing
    Laghu -> Nothing
    ...
    LakeMiwok -> Nothing
    Lakha -> Nothing
    Laki -> Just "له کی له کستان"
    Lakkia -> Nothing
    Lakona -> Nothing
    Lakonde -> Nothing
    Lakota -> Just "Lakȟótiyapi"
    LakotaDida -> Nothing
    Lakurumau -> Nothing
    Lala -> Nothing
    LalaBisa -> Nothing
    ...
    Latgalian -> Nothing
    Latin -> Just "lingua Latīna"
    Latu -> Nothing
    Latunde -> Nothing
    Latvian -> Just "latviešu"
    ...
    Likwala -> Nothing
    Lilau -> Nothing
    Lillooet -> Just "Sƛ’aƛ’imxǝc"
    Limassa -> Nothing
    Limbu -> Just "ᤛᤡᤖᤡᤈᤨᤅ"
    Limbum -> Nothing
    LimburganLimburgish -> Just "Lèmburgs"
    LimiYi -> Nothing
    Limilngan -> Nothing
    ...
    Loma_Liberia -> Just "Lö(g)ömàgòòi"
    Lomaiviti -> Nothing
    Lomavren -> Nothing
    Lombard -> Just "lumbard"
    Lombi -> Nothing
    Lombo -> Nothing
    Lomwe -> Nothing
    Loncong -> Nothing
    ...
    LoupA -> Nothing
    LoupB -> Nothing
    LowGerman -> Just "Plattdüütsch; Neddersass'sch"
    Lowa -> Nothing
    ...
    LowerSorbian -> Just "dolnoserbski"
    ...
    Lungga -> Nothing
    Luo -> Nothing
    Luo_KenyaAndTanzania -> Just "Dholuo"
    LuopoheHmong -> Nothing
    Luri -> Nothing
    Lusengo -> Nothing
    Lushai -> Nothing
    Lushootseed -> Just "Dəxʷləšucid"
    Lusi -> Nothing
    Lusitanian -> Nothing
    Lutos -> Nothing
    Luvale -> Nothing
    Luwati -> Nothing
    Luwo -> Nothing
    Luxembourgish -> Just "Lëtzebuergesch"
    Luyana -> Nothing
    Luyia -> Nothing
    Lwalu -> Nothing
    Lwel -> Nothing
    ...
    Malay_Generic -> Just "bahasa Melayu"
    Malay_IndividualLanguage -> Nothing
    Malayalam -> Just "മലയാളം"
    ...
    MalecitePassamaquoddy -> Just "Peskotomuhkati"
    MalekuJaika -> Nothing
    Maleng -> Nothing
    ...
    Manangba -> Nothing
    Manangkari -> Nothing
    Manchu -> Just "ᠮᠠᠨᠵᡠ ᡤᡳᠰᡠᠨ"
    Manda_Australia -> Nothing
    Manda_India -> Nothing
    Manda_Tanzania -> Nothing
    Mandahuaca -> Nothing
    Mandaic -> Just "Mandāyì"
    Mandan -> Just "Rų́ʼeta:re"
    Mandandanyi -> Nothing
    Mandar -> Nothing
    Mandara -> Nothing
    Mandari -> Nothing
    MandarinChinese -> Just "官話; 北方話"
    Mandeali -> Nothing
    Mander -> Nothing
    Mandingo -> Nothing
    Mandinka -> Nothing
    ...
    Mefele -> Nothing
    Megam -> Nothing
    MeglenoRomanian -> Just "meglenoromană"
    Mehek -> Nothing
    Mehinaku -> Nothing
    Mehri -> Nothing
    Meitei -> Just "মৈইতৈইলোন"
    Mekeo -> Nothing
    Mekmek -> Nothing
    Mekwei -> Nothing
    MelKhaonh -> Nothing
    ...
    Mende_SierraLeone -> Just "Mɛnde"
    Mengaka -> Nothing
    Mengen -> Nothing
    Mengisa -> Nothing
    Menka -> Nothing
    Menominee -> Just "Omāēqnomenew"
    Mentawai -> Nothing
    Menya -> Nothing
    Meoswar -> Nothing
    Mer -> Nothing
    ...
    Milyan -> Nothing
    Mimi -> Nothing
    MinBeiChinese -> Just "闽北"
    MinDongChinese -> Just "閩東語"
    ...
    Minaean -> Nothing
    Minang -> Nothing
    Minangkabau -> Just "Baso Minangkabau"
    Minanibai -> Nothing
    Minaveha -> Nothing
    Minderico -> Nothing
    Mindiri -> Nothing
    MingangDoso -> Nothing
    Mingrelian -> Just "მარგალური"
    ...
    MonsangNaga -> Nothing
    Montagnais -> Nothing
    Montenegrin -> Just "crnogorski / црногорски"
    Montol -> Nothing
    Monumbo -> Nothing
    Monzombo -> Nothing
    Moo -> Nothing
    ...
    MoriBawah -> Nothing
    Morigi -> Nothing
    Moriori -> Just "Ta Rē Moriori"
    Morisyen -> Just "morisyin"
    Moro -> Nothing
    ...
    Nalu -> Nothing
    NaluoYi -> Nothing
    Nama_Namibia -> Just "Khoekhoegowab"
    ...
    Nauna -> Nothing
    Nauo -> Nothing
    Nauru -> Just "ekakairũ naoero"
    Navajo -> Just "Diné bizaad"
    ...
    NewGreek -> Just "Ελληνικά"
    NewZealandSignLanguage -> Nothing
    Newari -> Just "नेपाल भाषा"
    Neyo -> Nothing
    NezPerce -> Nothing
    NgaLa -> Nothing
    ...
    NorthMuyu -> Nothing
    NorthNdebele -> Just "isiNdebele"
    NorthNuaulu -> Nothing
    NorthPicene -> Nothing
    NorthSlavey -> Just "Sahtú Got’ine"
    ...
    NortheasternThai -> Just "ภาษาอีสาน"
    ...
    NorthernFrisian -> Just "Nordfriisk"
    ...
    NorthwesternOjibwa -> Just "Anishinaabemowin (Ojibwemowin)"
    NorthwesternTamang -> Nothing
    Norwegian -> Just "norsk"
    NorwegianBokmal -> Just "Bokmål"
    NorwegianNynorsk -> Just "Nynorsk"
    ...
    Oirata -> Nothing
    Ojibwa -> Just "ᐊᓂᔑᓇᐯᒧᐎᓐ (Anishinaabemowin)"
    ...
    OldCham -> Nothing
    OldChinese -> Nothing
    OldChurchSlavonic -> Just "ѩзыкъ словѣньскъ"
    OldCornish -> Nothing
    OldDutch -> Nothing
    OldFrench -> Nothing
    OldFrisian -> Nothing
    ...
    Oti -> Nothing
    Otoro -> Nothing
    Ottawa -> Just "Nishnaabemwin (Daawaamwin)"
    OttomanTurkish -> Just "لسان عثمانى"
    Otuho -> Nothing
    Otuke -> Nothing
    Ouma -> Nothing
    Oune -> Nothing
    ...
    Patpatar -> Nothing
    Pattani -> Nothing
    PattaniMalay -> Just "Kecek Taning/Klate"
    Pattapu -> Nothing
    Patwin -> Nothing
    Paulohi -> Nothing
    Paumari -> Nothing
    ...
    Penesak -> Nothing
    Pengo -> Nothing
    PennsylvaniaGerman -> Just "Pennsilfaani-Deitsch"
    ...
    Plautdietsch -> Just "Plautdietsch"
    Playero -> Nothing
    Pnar -> Nothing
    PochuriNaga -> Nothing
    Pochutec -> Nothing
    ...
    Qabiao -> Nothing
    Qaqet -> Nothing
    Qashqai -> Just "Qaşqaycə"
    Qatabanian -> Nothing
    Qau -> Nothing
    Qawasqar -> Just "alacalufe"
    QilaMuji -> Nothing
    Qimant -> Nothing
    ...
    Rangkas -> Nothing
    Ranglong -> Nothing
    Rangpuri -> Just "রংপুরী"
    Rao -> Nothing
    Rapa -> Nothing
    Rapanui -> Just "rapanui"
    Rapoisi -> Nothing
    Rapting -> Nothing
    Rarotongan -> Just "Māori Kūki 'Āirani"
    Rasawa -> Nothing
    Ratagnon -> Nothing
    Ratahan -> Nothing
    Rathawi -> Nothing
    ...
    Resigaro -> Nothing
    Retta -> Nothing
    ReunionCreoleFrench -> Just "Kréol Rénioné"
    Reyesano -> Nothing
    Riang_India -> Nothing
    ...
    Rogo -> Nothing
    Rohingya -> Just "Ruáingga"
    Roma -> Nothing
    Romagnol -> Just "Rumagnòl"
    Romam -> Nothing
    Romanian -> Just "română"
    ...
    Russian -> Just "русский"
    RussianSignLanguage -> Nothing
    Rusyn -> Just "русин"
    RuthenianRusyn -> Just "Руски"
    Rutul -> Nothing
    Ruund -> Nothing
    Ruwila -> Nothing
    Rwa -> Nothing
    ...
    SaintLucianCreoleFrench -> Just "kwéyòl"
    Saisiyat -> Nothing
    Sajalong -> Nothing
    SajauBasap -> Nothing
    ...
    Sasak -> Nothing
    Sasaru -> Nothing
    SassareseSardinian -> Just "sassaresu"
    Satawalese -> Nothing
    SatereMawe -> Nothing
    SaterlandFrisian -> Just "Seeltersk"
    ...
    SebobKenyah -> Nothing
    Sebuyau -> Nothing
    Sechelt -> Just "Shashishalhem"
    Secoya -> Nothing
    Sedang -> Nothing
    Sedoa -> Nothing
    Seediq -> Just "Kari Seediq"
    Seeku -> Nothing
    Segai -> Nothing
    Segeju -> Nothing
    Seget -> Nothing
    ...
    Sera -> Nothing
    Serawai -> Nothing
    Serbian -> Just "српски / srpski"
    SerboCroatian -> Just "српскохрватски / hrvatskosrpski"
    Sere -> Nothing
    Serer -> Nothing
    Seri -> Just "Cmiique Iitom"
    Serili -> Nothing
    Seroa -> Nothing
    Serrano -> Nothing
    Seru -> Nothing
    ...
    Seti -> Nothing
    Settla -> Nothing
    SevernOjibwa -> Just "ᐊᓂᔑᓂᓂᒧᐎᓐ (Anishininiimowin)"
    SewaBay -> Nothing
    ...
    SouthMuyu -> Nothing
    SouthNdebele -> Just "Ndébélé"
    SouthNuaulu -> Nothing
    SouthPicene -> Nothing
    SouthSlavey -> Just "ᑌᓀᒐ"
    ...
    SouthernSami -> Just "saemi"
    SouthernSamo -> Nothing
    SouthernSierraMiwok -> Nothing
    SouthernSotho -> Just "Sesotho"
    ...
    Spanish_Castilian -> Just "español"
    SpitiBhoti -> Nothing
    Spokane -> Nothing
    Squamish -> Nothing
    Sranan -> Just "Sranang Tongo"
    ...
    StodBhoti -> Nothing
    Stoney -> Just "Isga Iʼabi"
    StraitsSalish -> Just "xʷsenəčqən"
    Suabo -> Nothing
    Suarmin -> Nothing
    Suau -> Nothing
    Suba -> Nothing
    ...
    Sumbawa -> Nothing
    Sumbwa -> Nothing
    Sumerian -> Just "eme-ĝir"
    SumiNaga -> Nothing
    SumoMayangna -> Nothing
    SumtuChin -> Nothing
    Sunam -> Nothing
    Sundanese -> Just "basa Sunda"
    Sungkai -> Nothing
    Sunwar -> Nothing
    Suoy -> Nothing
    ...
    Suya -> Nothing
    Svan -> Just "ლუშნუ"
    Swabian -> Just "Schwäbisch"
    Swahili_Generic -> Just "kiswahili"
    Swahili_Specific -> Nothing
    Swati -> Just "siSwati"
    Swedish -> Just "svenska"
    SwedishSignLanguage -> Just "svenskt teckenspråk"
    ...
    Tacana -> Nothing
    Tacanec -> Nothing
    Tachawit -> Just "Tachawit"
    Tachelhit -> Just "تشلحيت"
    Tachoni -> Nothing
    Tadyawan -> Nothing
    Tae -> Nothing
    Tafi -> Nothing
    ...
    TagalMurut -> Nothing
    Tagalaka -> Nothing
    Tagalog -> Just "Tagálog"
    Tagargrent -> Nothing
    Tagbanwa -> Just "tabanawa"
    Tagbu -> Nothing
    Tagdal -> Nothing
    Tagin -> Nothing
    Tagish -> Just "Tāgizi"
    ...
    Tawala -> Nothing
    TawallammatTamajaq -> Just "تَمَاجِقْ"
    Tawande -> Nothing
    TawangMonpa -> Nothing
    Tawara -> Nothing
    Taworta -> Nothing
    ...
    Togoyo -> Nothing
    TohonoOodham -> Just "O'odham"
    Tojolabal -> Nothing
    TokPisin -> Just "Tok Pisin"
    Tokano -> Nothing
    Tokelau -> Nothing
    TokharianA -> Nothing
    TokharianB -> Nothing
    TokiPona -> Just "toki pona"
    TokuNoShima -> Nothing
    Tol -> Nothing
    Tolaki -> Nothing
    Tolomako -> Nothing
    ...
    Tonga_Nyasa -> Just "chiTonga"
    Tonga_Thailand -> Nothing
    Tonga_TongaIslands -> Just "faka-Tonga"
    ...
    Tsimshian -> Just "Sm’algyax̣"
    Tsishingini -> Nothing
    Tso -> Nothing
    Tsoa -> Nothing
    Tsogo -> Nothing
    Tsonga -> Just "Xitsonga"
    Tsotsitaal -> Nothing
    Tsotso -> Nothing
    Tsou -> Nothing
    TsucubaCuba -> Nothing
    ...
    TumbalaChol -> Nothing
    Tumbuka -> Just "chiTumbuka"
    Tumi -> Nothing
    Tumleo -> Nothing
    Tumshuqese -> Nothing
    Tumtum -> Nothing
    TumulungSisaala -> Nothing
    Tumzabt -> Just "تومزابت"
    TundraEnets -> Nothing
    Tunen -> Nothing
    Tungag -> Nothing
    Tunggare -> Nothing
    ...
    TunisianSpokenArabic -> Just "تونسي"
    Tunjung -> Nothing
    Tunni -> Nothing
    Tuotomb -> Nothing
    Tupari -> Nothing
    Tupi -> Nothing
    Tupinamba -> Just "abáñe'enga"
    Tupinikin -> Nothing
    Tupuri -> Nothing
    Turaka -> Nothing
    Turi -> Nothing
    Turiwara -> Nothing
    Turka -> Nothing
    Turkana -> Just "Ng'aturk(w)ana"
    TurkicKhalaj -> Just "Qalayce"
    Turkish -> Just "Türkçe"
    TurkishSignLanguage -> Nothing
    Turkmen -> Just "Түркмен"
    TurksAndCaicosCreoleEnglish -> Nothing
    Turoyo -> Nothing
    Turumsa -> Nothing
    Turung -> Nothing
    Tuscarora -> Just "Skarù∙rę’"
    Tutelo -> Nothing
    TutohKenyah -> Nothing
    Tutong1 -> Nothing
    Tutong2 -> Nothing
    ...
    UpperPokomo -> Nothing
    UpperSaxon -> Just "Sächsisch"
    UpperSorbian -> Just "hornjoserbsce"
    UpperTanana -> Nothing
    ...
    Veluws -> Nothing
    VemgoMabas -> Nothing
    Venda -> Just "Tshivenḓa"
    Venetian -> Just "veneto"
    Venetic -> Nothing
    ...
    Waray_Philippines -> Just "Winaray"
    Wardaman -> Nothing
    Wardandi -> Nothing
    Warduji -> Nothing
    Ware -> Nothing
    ...
    WestUvean -> Nothing
    WestYugur -> Nothing
    WesternAbnaki -> Just "Wôbanakiôdwawôgan"
    WesternArmenian -> Just "Արեւմտահայերէն"
    ...
    WesternFarsi -> Just "فارسی"
    WesternFijian -> Nothing
    WesternFrisian -> Just "Frysk"
    ...
    WesternNeoAramaic -> Just "ܐܪܡܝܬ, آرامي"
    WesternNigerFulfulde -> Nothing
    WesternOjibwa -> Just "Anihšināpēmowin (Nakawēmowin)"
...
languageEndonymToText :: Language -> Maybe T.Text
languageEndonymToText endonym =
  case endonym of
    APucikwar -> Nothing
    Aari -> Nothing
    Aariya -> Nothing
